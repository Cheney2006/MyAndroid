 ...
 ******************************************************
 */
public class KeerAlertDialog implements OnClickListener{

	private Context context;
	private String title, message, positiveText, neutralText, negativeText;
	private AlertDialog alertDialog;

	public KeerAlertDialog(Context context, String title, String message) {
		this(context, title, message, "确定", null, null);
	}

    public KeerAlertDialog(Context context, String title, String message, String positiveText) {
        this(context, title, message, positiveText, null, null);
    }

    public KeerAlertDialog(Context context, String title, String message, String positiveText, String negativeText) {
        this(context, title, message, positiveText, null, negativeText);
    }

	public KeerAlertDialog(Context context, String title, String message, String positiveText, String neutralText, String negativeText) {
