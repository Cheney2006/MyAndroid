...
public abstract class JsonAdapter extends BaseAdapter {
    ...
    protected JsonAdapter(Context context, Json datas) {
    ...
    public void replaceData(int position, Json data) {
        this.datas.replaceItem(position, data);
        notifyDataSetChanged();
    }

    public void removeData(int position){
        this.datas.deleteItem(position);
        notifyDataSetChanged();
    }
