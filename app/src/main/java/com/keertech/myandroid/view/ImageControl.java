...
public class ImageControl extends ImageView {
     ...
     */
    public void imageInit(int contentW, int contentH,
                          int topHeight, ICustomMethod iCustomMethod) {
        BitmapDrawable bd = (BitmapDrawable) this.getDrawable();
        if (bd != null) {
            this.primaryBitmap = bd.getBitmap();
        }
...
//        } else {
            ...
            if (currentHeight > contentH) {
                limitY1 = -(currentHeight - contentH-140); // 平移限制
                limitY2 = 140;
            ...
            if (currentWidth > contentW) {
                limitX1 = -(currentWidth - contentW-40);
                limitX2 = 40;
                isMoveX = true;
