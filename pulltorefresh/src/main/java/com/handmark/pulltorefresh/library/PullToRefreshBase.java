...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private boolean mScrollLoadMore;
    // ===========================================================
    // Constructors
    // ===========================================================
    ...
    protected void onLoadingMore(final boolean doScroll) {
        if(isScrollLoadMore()){
            mFooterLayout.refreshing();
            if (doScroll) {
                if (mShowViewWhileRefreshing) {
    ...
    protected void onResetLoadMore() {
        mIsBeingDragged = false;
        mLayoutVisibilityChangesEnabled = true;
    ...
    private void callScrollLoadingMoreListener() {
        mOnRefreshListener2.onPullUpToRefresh(this);
    }
    ...
    public boolean isScrollLoadMore() {
        return mScrollLoadMore;
    }

    public void setScrollLoadMore(boolean mScrollLoadMore) {
        this.mScrollLoadMore = mScrollLoadMore;
    }
}
